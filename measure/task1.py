...
def t1_ShortestPath(Gs, print_lim=sys.maxsize):
...
def t1_ACT(Gs, print_lim=sys.maxsize):
    nodes = list(Gs[0].nodes)
...
def t1_MCT(Gs, print_lim=sys.maxsize):
    nodes = list(Gs[0].nodes)
...
def t1_Katz(Gs, print_lim=sys.maxsize):
    nodes = list(Gs[0].nodes)
